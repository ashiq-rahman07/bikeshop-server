...
export const gearProducts = [
  {
    ...
    description:
      'Premium carbon fiber helmet with advanced ventilation system and integrated Bluetooth communication. This lightweight helmet offers superior protection while maintaining excellent comfort during long rides.',
    features: [
  ...
  },
  {
    ...
    price: 449.99,
    description:
      'All-weather adventure jacket with removable thermal liner and CE-approved impact protection. Perfect for year-round riding with its waterproof outer shell and adjustable ventilation system.',
    features: [
  ...
  },
  {
    ...
    description:
      'Premium racing gloves with superior grip and knuckle protection for maximum control and safety. Features kangaroo leather palm for exceptional feel and tactile response during high-performance riding.',
    features: [
  ...
  },
  {
    ...
    price: 279.99,
    description:
      'Waterproof touring boots designed for long-distance comfort and protection. Features GORE-TEX® membrane for breathable waterproofing and reinforced shin and ankle protection.',
    features: [
  ...
  },
  {
    ...
    description:
      'Reinforced riding pants with CE-approved armor and abrasion-resistant material. Designed for both on-road and light off-road use with adjustable fit and ventilation.',
    features: [
  ...
  },
  {
    ...
    price: 89.99,
    description:
      'Motorcycle-specific hydration backpack with 2L water capacity and reflective details. Aerodynamic design with stabilizing chest and waist straps for secure fit at high speeds.',
    features: [
  ...
  },
  {
    ...
    price: 69.99,
    description:
      'Moisture-wicking base layer designed for all-season comfort under your riding gear. Helps regulate body temperature in both hot and cold conditions with antimicrobial properties.',
    features: [
  ...
  },
  {
    ...
    description:
      'Premium Bluetooth communicator with 1.6km range and HD audio quality. Features mesh networking technology for group rides and voice-activated controls for hands-free operation.',
    features: [
